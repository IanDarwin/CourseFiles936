...
set "JAVA_OPTS=-Xms2800m -Xmx2800m -XX:MetaspaceSize=128m -XX:MaxMetaspaceSize=512m"
set "JAVA_OPTS=%JAVA_OPTS% -Djava.net.preferIPv4Stack=true -Djboss.as.management.blocking.timeout=600"
